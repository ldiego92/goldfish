...
class CreateCopyOfPeriodicPublicationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('copy_of_periodic_publications', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::drop('copy_of_periodic_publications');
    }
}
